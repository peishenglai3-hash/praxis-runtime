...
is GitHub Actions run `35422401720`, whose machine-readable artifacts point to
commit `9da7f2840e4e`.

| Surface                         | Status               | Evidence / boundary                                                                                                     |
| ------------------------------- | -------------------- | ----------------------------------------------------------------------------------------------------------------------- |
| Windows x64 + Node 22.13.0      | `SUPPORTED / TESTED` | Exact `pnpm verify` passed in GitHub Actions run `35422401720`; artifact commit and runtime match.                      |
| Ubuntu/Linux x64 + Node 22.13.0 | `SUPPORTED / TESTED` | Exact `pnpm verify` passed in GitHub Actions run `35422401720`; artifact commit and runtime match.                      |
