...
is GitHub Actions run `35422691407`, whose machine-readable artifacts point to
commit `a55ee2d56799`.

| Surface                         | Status               | Evidence / boundary                                                                                                     |
| ------------------------------- | -------------------- | ----------------------------------------------------------------------------------------------------------------------- |
| Windows x64 + Node 22.13.0      | `SUPPORTED / TESTED` | Exact `pnpm verify` passed in GitHub Actions run `35422691407`; artifact commit and runtime match.                      |
| Ubuntu/Linux x64 + Node 22.13.0 | `SUPPORTED / TESTED` | Exact `pnpm verify` passed in GitHub Actions run `35422691407`; artifact commit and runtime match.                      |
