...
| Exact Node 22 CI                 | `PASS`          | Run `35422995773` passed both Ubuntu and Windows; artifacts report Node `22.13.0`, `dirty: false`, all 11 stages complete and `notRun: []` for commit `46a461a`. |
