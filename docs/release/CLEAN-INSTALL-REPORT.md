...
| Exact Node 22 CI                 | `PASS`          | Run `35427872938` passed both Ubuntu and Windows after the Windows job rerun; artifacts report Node `22.13.0`, `dirty: false`, all 11 stages complete and `notRun: []` for commit `58b15f5`. |
