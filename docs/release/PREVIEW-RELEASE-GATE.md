...
| High correctness/data-loss defects | `NO CURRENT OBSERVED BLOCKER`  | Exact candidate run `35427872938` passed both runners; no high correctness/data-loss failure surfaced in the final gate.                         |
| Windows Node 22.13.0               | `PASS`                         | Run `35427872938`; artifact is Node `22.13.0`, clean, complete and points to `58b15f5`.                                                          |
| Ubuntu Node 22.13.0                | `PASS`                         | Run `35427872938`; artifact is Node `22.13.0`, clean, complete and points to `58b15f5`.                                                          |
