...
**Date:** 2026-09-18  
**Source:** local archive `D:\红色源代码：洪湖篇\人机民族志档案_洪湖篇_20260908` and its sibling interaction-record export.  
...
| --------------------------------------------------------- | ------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Honghu archive and de-identified research layer exist     | **FOUND**     | Archive `README.md` states the 2026-09-08 export contains 11,411 visible research-layer messages, 5,999 tool/artifact records, and a SHA-256-verified sealed source layer.                                                                                                                                                              |
