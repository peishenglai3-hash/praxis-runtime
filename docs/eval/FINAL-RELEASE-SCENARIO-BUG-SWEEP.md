...
run `35422401720` passed the canonical 11-stage gate on both Ubuntu and Windows
at commit `9da7f2840e4e`. The scenario table remains conservative because the
