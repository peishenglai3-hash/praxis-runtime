...
run `35427872938` passed the canonical 11-stage gate on both Ubuntu and Windows
at commit `58b15f5a0440b669dd7fe0768264822d81ebc6e2`. The scenario table remains conservative because the
