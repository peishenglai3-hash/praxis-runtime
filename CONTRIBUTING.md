...
**This project is an engineering preview, not a stable release.** Read the
status note at the top of the [README](./README.md) first. Phases 5, 5.5, 6A
and 6B are implemented; Phase 6V remains evidence-limited. Contracts, schema
and the command-line surface can still change without notice.
